    ...
    public function update(Request $request)
    {
        ...
        DB::transaction(function () use ($client, $branch, $settings, $validated, $request, $logoPath) {
            ...
            $settings->update([
                ...
                'efris_tin' => ($validated['efris_tin'] ?? null) ?: null,
                'efris_legal_name' => ($validated['efris_legal_name'] ?? null) ?: null,
                'efris_business_name' => ($validated['efris_business_name'] ?? null) ?: null,
                'efris_branch_code' => ($validated['efris_branch_code'] ?? null) ?: null,
                'efris_device_serial' => ($validated['efris_device_serial'] ?? null) ?: null,
                'efris_auth_url' => ($validated['efris_auth_url'] ?? null) ?: null,
                'efris_submission_url' => ($validated['efris_submission_url'] ?? null) ?: null,
                'efris_reversal_url' => ($validated['efris_reversal_url'] ?? null) ?: null,
                'efris_username' => ($validated['efris_username'] ?? null) ?: null,
                'efris_password' => filled($validated['efris_password'] ?? null)
                    ? $validated['efris_password']
                    : $settings->efris_password,
                'efris_client_id' => ($validated['efris_client_id'] ?? null) ?: null,
                'efris_client_secret' => filled($validated['efris_client_secret'] ?? null)
                    ? $validated['efris_client_secret']
                    : $settings->efris_client_secret,
                'receipt_header' => ($validated['receipt_header'] ?? null) ?: null,
                'receipt_footer' => ($validated['receipt_footer'] ?? null) ?: null,
                'invoice_footer' => ($validated['invoice_footer'] ?? null) ?: null,
                'invoice_payment_details' => ($validated['invoice_payment_details'] ?? null) ?: null,
                'report_footer' => ($validated['report_footer'] ?? null) ?: null,
