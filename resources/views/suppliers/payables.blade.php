...
<head>
    ...
    <title>Supplier Payables - KIM Rx</title>
    <style>
    ...
    <div class="content" id="mainContent">
        ...
        <div class="panel">
            <div style="display:flex; justify-content:space-between; gap:12px; flex-wrap:wrap; align-items:center; margin-bottom:16px;">
                <div>
                    <h2 style="margin:0;">Outstanding Supplier Invoices</h2>
            ...
            <form method="GET" action="{{ route('suppliers.payables') }}" class="search-form">
                <input type="text" name="search" value="{{ $search }}" placeholder="Search by supplier, invoice, or product...">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($lastPayment)
                                        ...
                                        <span class="muted">{{ $lastPayment->paidByUser?->name ?? 'System' }}</span>
                                    @else
