...
<head>
    ...
    <title>Add Product - KIM Rx Softwares</title>
    <style>
        * {
                ...
                <form method="POST" action="{{ route('products.store') }}">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="strength" id="strength" value="{{ old('strength') }}" placeholder="e.g. 500mg">
                        </div>
                        ...
                        <div class="checkbox-group">
                            <input type="checkbox" name="track_batch" id="track_batch" value="1" {{ old('track_batch') ? 'checked' : '' }}>
                        ...
                        <div class="form-group" id="expiry_alert_days_wrap">
                            <label for="expiry_alert_days">Expiry Alert Days</label>
                            <input type="number" min="1" max="3650" name="expiry_alert_days" id="expiry_alert_days" value="{{ old('expiry_alert_days', 90) }}">
                            <div class="helper-text">
                                Warn staff when a tracked-expiry product is within this many days of expiry. Example: 15, 30, or 90.
                            </div>
                        </div>
