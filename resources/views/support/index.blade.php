    ...
    <main class="content" id="mainContent">
        ...
        <section class="panel">
            ...
            @if (!$support['phone_primary'] && !$support['email'] && !$support['whatsapp'])
                <div class="empty-note" style="margin-top: 18px;">
                    Support contacts have not been configured yet. Add the support phone, email, and WhatsApp in the server environment so every client can see the correct KIM DIGICORE LTD contact details here.
                </div>
            @endif
        </section>
        ...
        <section class="detail-grid">
            <article class="panel">
                ...
                <p class="panel-subtitle">These details help KIM DIGICORE LTD solve issues faster and avoid back-and-forth.</p>
                <ul class="list">
            ...
            <article class="panel">
                ...
                @if ($support['contact_person'] || $support['website'])
                    <div class="workspace-card" style="margin-top: 14px;">
                        <strong>KIM DIGICORE LTD Contact Desk</strong>
